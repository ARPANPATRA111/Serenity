...
- `git status --short`: dirty Phase 1 worktree is present.
...
- Staging verification remains blocked until an operator provides a confirmed staging URL, staging Firebase project, User A/User B test accounts, and a safe test inbox.
